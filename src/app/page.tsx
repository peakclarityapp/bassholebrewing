...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Subtle Admin Access - top right corner, blends in */}
      <Link
        href="/admin"
        className="fixed top-4 right-4 z-50 group"
        title="Admin"
      >
        <div className="w-8 h-8 rounded border border-zinc-800 bg-zinc-950/50 flex items-center justify-center text-zinc-700 hover:text-amber-500 hover:border-amber-500/30 transition-all duration-300 backdrop-blur-sm">
          <svg 
